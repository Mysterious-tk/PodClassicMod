...
object Colors {
    ...
    val brick_1 by lazy { arrayOf(getColor(R.color.brick_1), getColor(R.color.brick_3), getColor(R.color.brick_5), getColor(R.color.brick_7), getColor(R.color.brick_9)) }
    val brick_2 by lazy { arrayOf(getColor(R.color.brick_2), getColor(R.color.brick_4), getColor(R.color.brick_6), getColor(R.color.brick_8), getColor(R.color.brick_10)) }
